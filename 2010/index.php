...
<link rel="image_src" href="http://www.nattscenario.no/images/2010/page_thumb.jpg" />
...
<style type="text/css">
#contentarea {background:url('<?=$page == 'frontpage.php' ? 'images/2010/background_frontpage.jpg' :'images/2010/background_info.jpg' ?>');}
<?if ($page == 'frontpage.php') {?>
#frontpagelink {display:none;}
<? } ?>

#shadow {
    background-image: url('images/2010/background_shadow.png');
}
#corners {
    background-image: url('images/2010/background_corners.png');
}
</style>
...
<div align="center" >
	<div id="contentarea">
		...
		<div id="menubar">
			...
			<a id="menu_tipsogtriks" href="?p=tipsogtriks"<?=$pagegroup == 'tipsogtriks' ? ' class="selected"' : ''?>></a>
